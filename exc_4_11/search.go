...
func SearchIssues(terms []string) (*IssuesSearchResult, error) {
	...
	// use QueryEscape to make sure the string is safe
...
// with number we can get a specified issue
...
// without number we can get all issues from repo
...
func EditIssue(owner, repo, number string, fields map[string]string) (*Issue, error) {
	...
	// buf pass to body io.Reader
	// patch is for updating existing resources
	// put is for updating existing resources if they exist otherwise create new resources
	// post is for creating new resources only
